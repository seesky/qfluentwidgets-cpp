...
#include "../../qfluentwidgets/components/widgets/info_bar.h"
...
public slots:
    ...
    void showFlyout2(bool isChecked)
    {
        ...
        Flyout *w = Flyout::make(view, QVariant::fromValue<QWidget*>(this->button2), this, FlyoutAnimationType::PULL_UP, true);
        connect(view, &FlyoutView::closed, w, &Flyout::close);
    };

    void showFlyout3(bool isChecked)
    {
        Flyout::make(new CustomFlyoutView(nullptr), QVariant::fromValue<QWidget*>(this->button3), this, FlyoutAnimationType::DROP_DOWN, true);
    };
};
